...
/* ▼ border と borderColor の Warning 対策 */
...
export default function RankingPage() {
  ...
  if (loading) {
    return (
      <div style={pageStyle}>
        <div style={cardStyle}>ランキングを読み込み中です...</div>
      </div>
    );
  }
                ...
                {rateRanking.map((u) => {
                  ...
                  return (
                    <tr key={u.user_id}>
                      ...
                      <td style={tdRight}>{u.wins}</td>
                      <td style={tdRight}>{u.losses}</td>
                    </tr>
                  );
                })}
              </tbody>
